...
//     const fetchData = async () => {
//       try {
//         console.log("API를 호출 합니다.")
//         console.log("현재 토큰 상태:", userToken ? "토큰 있음" : "토큰 없음")
...
//         console.log("과목 API 응답 상태코드:", subjectRes.status)
...
//             const arrayKey = Object.keys(subjectData).find(key => Array.isArray(subjectData[key]))
//             if (arrayKey) {
//               finalSubjects = subjectData[arrayKey]
...
//           setSubjects(finalSubjects)
//         } else {
//           console.error("백엔드에서 과목 데이터를 불러오지 못했습니다.(토큰 만료나 주소 문제 의심)")
//         }
...
//       // const startTime = new Date(endTime.getTime() - studySeconds * 1000)
...
//           startTime: actualStartTime.toISOString(),
//           endTime: actualEndTime.toISOString(),
//           sumStudyTime: studyMinutes //studySeconds
//         })
//       })
...
//       <div style={{ flex: 6.5, display: 'flex', flexDirection: 'column', gap: '20px' }}>
//         <div>
//           <Timer userName="나 아" selectedSubject={selectedSubject} onSaveTime={handleSaveRecord} />
//         </div>
//         <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
//           <TodoList />
//         </div>
