  ...
  const handleTypeChange = (targetType) => {
    if (startDate && endDate) {
      ...
      if (targetType === "daily" && diffDays > 14) {
        alert(
          "선택된 기간이 14일을 초과하여 일간 조회로 전환할 수 없습니다. 달력에서 기간을 먼저 줄여주세요.",
        );
        return;
      }
      ...
      if (targetType === "weekly" && diffDays > 90) {
        alert(
          "선택된 기간이 3개월을 초과하여 주간 조회로 전환할 수 없습니다. 달력에서 기간을 먼저 줄여주세요.",
        );
        return;
      }
    }
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <h2 style={{ color: "#4A00E0", margin: "5px 0" }}>
              {Math.round(
                summary.currentPeriod.totalMinutes / 60,
              ).toLocaleString()}
              시간
            </h2>
          </div>
          <div style={{ textAlign: "center" }}>
            ...
            <h2 style={{ margin: "5px 0" }}>
              {Math.round(
                summary.previousPeriod.totalMinutes / 60,
              ).toLocaleString()}
              시간
            </h2>
          </div>
          <div style={{ textAlign: "center" }}>
            ...
            >
              {summary.comparison.differenceMinutes > 0 ? "+" : ""}
              {Math.round(
                summary.comparison.differenceMinutes / 60,
              ).toLocaleString()}
              시간
            </p>
