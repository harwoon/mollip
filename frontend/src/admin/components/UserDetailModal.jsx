...
import { getStudyTrend, getSubjectRecord, getTodoTrend } from "../features/user/api/user.js"
...
export default function UserDetailModal({ user, onClose }) {
    ...
    const handleExcelDownload = async () => {
        ...
        try {
            ...
            XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(profileData), "유저프로필")
            XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(studyData), "총_공부시간_추이")
            XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(subjectData), "과목별_공부기록")
            XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(todoData), "Todo_달성률")
